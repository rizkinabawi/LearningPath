...
const styles = StyleSheet.create({
  ...
  hBlob1: { position: "absolute", width: 180, height: 180, borderRadius: 90, backgroundColor: "rgba(255,255,255,0.1)", top: -50, right: -50 },
  hBlob2: { position: "absolute", width: 100, height: 100, borderRadius: 50, backgroundColor: "rgba(255,255,255,0.07)", bottom: -20, left: 30 },
  headerTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 18 },
  headerSub: { fontSize: 11, color: "rgba(255,255,255,0.6)", fontWeight: "700", textTransform: "uppercase", letterSpacing: 1.5 },
  headerTitle: { fontSize: 28, fontWeight: "900", color: "#fff", letterSpacing: -0.5 },
  streakBadge: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: "rgba(255,255,255,0.2)", paddingHorizontal: 12, paddingVertical: 7, borderRadius: 999 },
  streakText: { fontSize: 13, fontWeight: "800", color: "#fff" },
  summaryRow: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 16, overflow: "hidden" },
  summaryChip: { flex: 1, alignItems: "center", paddingVertical: 12, gap: 2 },
  summaryVal: { fontSize: 18, fontWeight: "900", color: "#fff" },
  summaryLbl: { fontSize: 9, color: "rgba(255,255,255,0.6)", fontWeight: "700", textTransform: "uppercase" },
  scroll: { padding: 16, paddingBottom: 40, gap: 10 },
  sectionTitle: { fontSize: 17, fontWeight: "900", color: Colors.dark, letterSpacing: -0.3, marginBottom: 10 },
  modeGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  modeCard: { width: (width - 32 - 10) / 2, borderRadius: 22, overflow: "hidden" },
  modeGrad: { padding: 18, minHeight: 150, overflow: "hidden", justifyContent: "flex-end" },
  modeBlob: { position: "absolute", width: 100, height: 100, borderRadius: 50, backgroundColor: "rgba(255,255,255,0.1)", top: -20, right: -20 },
  modeIconWrap: { width: 44, height: 44, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center", marginBottom: 10 },
  modeLabel: { fontSize: 16, fontWeight: "900", color: "#fff", marginBottom: 3 },
  modeSub: { fontSize: 11, color: "rgba(255,255,255,0.7)", fontWeight: "500", lineHeight: 15 },
  modeArrow: { position: "absolute", top: 14, right: 14, width: 28, height: 28, borderRadius: 8, backgroundColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center" },
  courseList: { gap: 8 },
  courseRow: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: Colors.white, borderRadius: 18, padding: 14 },
  courseRowIcon: { width: 42, height: 42, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  ...
  emptyGrad: { padding: 32, alignItems: "center", gap: 10, minHeight: 180, overflow: "hidden" },
  ...
  emptyBtn: { backgroundColor: "rgba(255,255,255,0.25)", paddingHorizontal: 22, paddingVertical: 11, borderRadius: 12, marginTop: 4 },
